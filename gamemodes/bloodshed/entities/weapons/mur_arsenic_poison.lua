...
function SWEP:DrawHUD()
	...
	draw.SimpleText(MuR.Language["loot_cyanide"] or "LMB to poison", "MuR_Font1", ScrW()/2, ScrH()-He(100), color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
end
