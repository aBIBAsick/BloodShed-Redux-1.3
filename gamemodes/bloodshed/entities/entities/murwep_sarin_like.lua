        ...
        if self.Activated then
            ...
            if CurTime() > self.NextGasEmit then
                ...
                if IsValid(smoke) then
                    ...
                    smoke:SetKeyValue("startcolor", "150 150 150") -- Greyish
                    smoke:SetKeyValue("endcolor", "150 150 150")
                    smoke:SetKeyValue("opacity", "0.4") -- Less visible than mustard
                ...
                for _, ply in player.Iterator() do
                    if ply:GetPos():Distance(pos) < 350 then -- Slightly larger radius for nerve agent
                        if ply:Alive() then
